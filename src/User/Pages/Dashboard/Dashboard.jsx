            ...
            <tbody>
              ...
              {itemDetails.colors.map((color, index) => (
                <tr key={index}>
                  ...
                  {index === 0 && (
                    <td
                      rowSpan={itemDetails.colors.length}
                      className={`total ${getTotalClass(itemDetails.total)}`}
                    >
                      {itemDetails.total}
                    </td>
                  )}
              ...
              <tr>
                ...
                <td
                  className={`finished ${getTotalClass(itemDetails.finished)}`}
                >
              ...
              <table className="excel-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      className={`finished ${getTotalClass(totals.finished)}`}
                    >
                      {totals.finished}
                    </td>
                  </tr>
